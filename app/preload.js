...
contextBridge.exposeInMainWorld("mytvRunner", {
  ...
  getHostEntryStatus: () => ipcRenderer.invoke("get-host-entry-status"),
  addHostEntry: () => ipcRenderer.invoke("add-host-entry"),
  removeHostEntry: () => ipcRenderer.invoke("remove-host-entry"),
  ...
  saveTextFile: (values) => ipcRenderer.invoke("save-text-file", values),
